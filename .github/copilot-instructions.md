...
SUPERADMIN_ORGANIZATION="Default Organization"
...
### Testing
- **Run tests**: `pnpm test` -- FAILS without Prisma client generation
- Tests are located in `tests/api/e2e/` directory
- Tests require database setup and environment variables
- **NEVER CANCEL**: Test suite would take 15+ minutes when functional. Set timeout to 30+ minutes.
