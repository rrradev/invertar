...
<div class="{sizeClasses} rounded-lg flex items-center justify-center mr-3 overflow-hidden">
	{#if loading}
		<!-- Loading state -->
		<div class="w-full h-full bg-gray-200 animate-pulse rounded-lg flex items-center justify-center">
	...
	{:else}
		...
		<div class="w-full h-full bg-gradient-to-r from-indigo-600 to-cyan-600 rounded-lg flex items-center justify-center">
